...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { todo_list_id: @bookmark.todo_list_id, user_id: @bookmark.user_id } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { todo_list_id: @bookmark.todo_list_id, user_id: @bookmark.user_id } }
